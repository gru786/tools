...
class NetSpeedTestScreen extends StatefulWidget {
  const NetSpeedTestScreen({Key? key}) : super(key: key);

  @override
  State<NetSpeedTestScreen> createState() => _NetSpeedTestScreenState();
}

class _NetSpeedTestScreenState extends State<NetSpeedTestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Internet Speed', style: TextStyle(
